...
- Root `README.md`, `scripts/validate_skills.py`, and CI are derived packaging and verification files; keep them synchronized with the four skill directories.
...
- Keep the repository limited to `bootstrap-repo`, `implement-milestone`, `fix-bug`, and `review-repo` plus the minimal packaging files.
